...
NAME = 'kwimage_ext'
INIT_PATH = 'kwimage_ext/__init__.py'
...
if __name__ == '__main__':
    ...
    if 0:
        setupkw['entry_points'] = {
            ...
            'console_scripts': [
                ...
                'kwimage_ext = kwimage_ext.__main__:main'
            ]
        }
    ...
    setupkw['extras_require'] = {
        ...
        # 'headless': parse_requirements('requirements/headless.txt'),  # kwimage_ext: +UNCOMMENT_IF(cv2)
        # 'graphics': parse_requirements('requirements/graphics.txt'),  # kwimage_ext: +UNCOMMENT_IF(cv2)
        # Strict versions
        # 'headless-strict': parse_requirements('requirements/headless.txt', versions='strict'),  # kwimage_ext: +UNCOMMENT_IF(cv2)
        # 'graphics-strict': parse_requirements('requirements/graphics.txt', versions='strict'),  # kwimage_ext: +UNCOMMENT_IF(cv2)
