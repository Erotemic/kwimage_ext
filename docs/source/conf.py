...
Notes:
    ...
    sphinx-apidoc -f -o ~/code/kwimage_ext/docs/source ~/code/kwimage_ext/kwimage_ext --separate
    make html
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/kwimage_ext/advanced/
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/kwimage_ext/versions/
"""
#
...
htmlhelp_basename = 'kwimage_extdoc'
