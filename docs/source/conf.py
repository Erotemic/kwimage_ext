...
Notes:
    ...
    sphinx-apidoc --private -f -o ~/code/kwimage_ext/docs/source ~/code/kwimage_ext/kwimage_ext --separate
    make html
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/kwimage-ext/advanced/
        ...
        For gitlab you also need to setup an integrations. Navigate to:
            ...
            https://readthedocs.org/dashboard/kwimage-ext/integrations/create/
        ...
        Then go to
            ...
            https://gitlab.kitware.com/computer-vision/kwimage_ext/hooks
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/kwimage-ext/versions/
"""
#
...
modpath = join(dirname(dirname(dirname(__file__))), 'kwimage_ext', '__init__.py')
...
# html_logo = '.static/kwimage_ext.svg'
# html_favicon = '.static/kwimage_ext.ico'
...
latex_documents = [
    (master_doc, 'kwimage_ext.tex', 'kwimage_ext Documentation',
...
man_pages = [
    (master_doc, 'kwimage_ext', 'kwimage_ext Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'kwimage_ext', 'kwimage_ext Documentation',
     author, 'kwimage_ext', 'One line description of project.',
     'Miscellaneous'),
]
