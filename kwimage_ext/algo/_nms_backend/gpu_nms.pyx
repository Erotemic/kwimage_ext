...
CPATH=$CPATH:$NUMPY_INCLUDE cythonize -a -i ~/code/kwimage_ext/kwimage_ext/algo/_nms_backend/gpu_nms.pyx

cd ~/code/kwimage_ext && ./setup.py develop

python -c "from kwimage_ext.algo._nms_backend import gpu_nms"
